...
spares = helpers.get_spares()

league_deschamps = models.League()

league_deschamps.players = players
league_deschamps.spares = spares

season_2024 = models.Season(name='2024-2025', start_date='2024-09-03', stop_date='2025-04-10')
...
league_deschamps.generate_games(season=season_2024, weekday=1, time='21:00', filter_=['2024-12-24', '2024-12-31'])
...
league_deschamps.replace_player(request_datetime=datetime(year=2024, month=8, day=29), player='Patrick', games=1, spare='Renaud')
league_deschamps.replace_player(request_datetime=datetime(year=2024, month=8, day=29), player='James', games=1, spare='Ami')
league_deschamps.replace_player(request_datetime=datetime(year=2024, month=8, day=30), player='Bruno', games=1)
...
league_deschamps.set_spare_availability('15147728092', False) # Daniel replied as non available
league_deschamps.set_spare_availability('14503745332', False) # Bruno replied as non available
